...
dataset_joined.drop(['Ticket', 'Cabin', 'Name' ], axis = 1, inplace = True)
...
X_train = dataset_train_revised.iloc[:, [0,1,2,4,5,6,8,9]]
y_train = dataset_train_revised.iloc[:, [7]]
X_test = dataset_test_revised.iloc[:, [0,1,2,4,5,6,8,9]]

#getting the PassIndex for the Submission dataset
pass_index = dataset_joined.iloc[891:,3]
...
only_final_values.to_csv('titanic_submission_final_5.csv', index = False)
